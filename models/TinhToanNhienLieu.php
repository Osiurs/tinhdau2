...
class TinhToanNhienLieu {
     ...
     */
    public function tinhNhienLieu($tenTau, $diemBatDau, $diemKetThuc, $khoiLuong) {
        ...
        if ($khoangCach === null) {
            ...
            $message .= "\nVui lòng chọn tuyến đường khác hoặc liên hệ quản trị viên để thêm tuyến đường mới.";
